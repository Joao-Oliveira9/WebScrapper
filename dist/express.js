...
async function botTeste() {
    ...
    await page.goto(URL);
    await page.waitForSelector("yt-formatted-string.style-scope.ytd-watch-metadata", { timeout: 5000 });
...
async function inserirOrigemDestino(page) {
    ...
    await page.type("#txtInputDestination--text-field.sc-gdyeKB.gUMYPB.sc-bDpDS.coUuHR.sc-YysOf.hQQeCu", "BSB");
    await page.keyboard.press("ArrowDown");
    await page.keyboard.press("Enter");
    await page.click("#btnContinueCTA.sc-kUXCeW.sc-eRdibt.lpYpc.hPAZrU");
}
