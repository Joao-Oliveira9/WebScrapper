...
async function testandoUrl() {
  try {
    ...
    await page.goto(
      "https://www.latamairlines.com/br/pt/oferta-voos?origin=SAO&inbound=2024-11-09T12%3A00%3A00.000Z&outbound=2024-11-05T12%3A00%3A00.000Z&destination=RIO&adt=1&chd=0&inf=0&trip=RT&cabin=Economy&redemption=false&sort=PRICE%2Casc"
    );
